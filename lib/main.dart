import 'package:anggita_news_app/views/article_view.dart';
...
class HomePage extends StatelessWidget {
  final NewsAPI _newsAPI = NewsAPI("dd557ba92ea642c4b98de74bde8f309b");
  ...
  Widget _buildTopHeadlinesTabView() {
    return FutureBuilder<List<Article>>(
        future: _newsAPI.getTopHeadlines(country: "id"),
